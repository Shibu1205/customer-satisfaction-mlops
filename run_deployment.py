...
@click.option(
    ...
    help="Optionally choose to only run the deployment "
     "pipeline to train and deploy a model ('deploy'), or "
...
def main(config:str,min_accuracy:float):
    ...
    if deploy:
        continuous_deployment_pipeline(data_path=r"D:\Ai projects\customer-satisfaction-mlops-main\venv\data\olist_customers_dataset.csv",
